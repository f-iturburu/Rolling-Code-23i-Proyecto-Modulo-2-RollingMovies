...
let modalRegisterSuccess = new bootstrap.Modal(
  document.getElementById("modalRegisterSuccess")
);
let modalRegisterFailed = new bootstrap.Modal(
  document.getElementById("modalRegisterFailed")
);
...
export function validateGeneral(e) {
  ...
  if (
    ...
    emailjs
      .send("service_lhhp93f", "template_z03qj7o", params, "OaYg6XmB036zfDoyB")
      .then(
        function (response) {
